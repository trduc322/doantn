    ...
    return (
        ...
        <div className="w-full">
            ...
            <div className="text-center py-[200px]">
                ...
                <div>
                    <button className="mt-[35px] uppercase rounded-md bg-[#e26e2c] text-white py-3 px-10 font-semibold hover:bg-[#e68042]" onClick={() => navigate('/findlaptop')}> Get Started </button>
                </div>
            </div>
        </div>  
    )
