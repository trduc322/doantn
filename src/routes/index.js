...
const Approuter = ({user}) => {
    return (
        <Router>
            <Routes>
                {user && !user.UserRole ? null : <Route path="/admin" element={<Admin user = {user}/>}></Route>}
                <Route path="/*" element={<MainLayout user={user}/>}>
                    <Route index element={<Home/>}/>
                    <Route path="findlaptop" element={<FindLaptop/>}/>
                    <Route path="laptopdetails/:id" element={<LaptopDetails user={user}/>}/>
                    <Route path="signin" element={<SignIn/>}/>
                    <Route path="comparelaptop" element={<CompareLaptop/>}/>
